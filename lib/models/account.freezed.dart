...
abstract class $AccountCopyWith<$Res> {
  ...
  $Res call({String? id, String? username, String? password, String? score});
}
...
class _$_Account with DiagnosticableTreeMixin implements _Account {
  const _$_Account({this.id, this.username, this.password, this.score});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Account(id: $id, username: $username, password: $password, score: $score)';
  }
